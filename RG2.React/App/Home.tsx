  ...
  return (
    <div>
      ...
      <div className="jumbotron">
        ...
        <br />
        <p className="lead">RG2 is a demo application from <a href="http://www.signumsoftware.com" title="Signum Software">Signum Software</a> based on Northwind database from Microsoft:</p>
        <p>
